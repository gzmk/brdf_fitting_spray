...
writetable(T,'/scratch/gk925/brdf_fitting_spray/gloss40_fit/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/brdf_fitting_spray/gloss40_fit');
...
imPath = ['/scratch/gk925/brdf_fitting_spray/gloss40_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
