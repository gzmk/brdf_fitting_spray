...
%     [XBest2,BestF2,Iters2] = Grid_Search(2, LB_2', UB_2', NumDiv_2, MinDeltaX_2, 1e-7, 1000, 'renderIm_2params');
    ...
    imname = strcat('/scratch/gk925/brdf_fitting_spray/gloss10_fit/fit_results/multispectral/', fitname1);
...
%     [XBest1,BestF1,Iters1] = Grid_Search(1, LB_1, UB_1, NumDiv_1, MinDeltaX_1, 1e-7, 1000, 'renderIm_1params');
    ...
    imname = strcat('/scratch/gk925/brdf_fitting_spray/gloss10_fit/fit_results/multispectral/', fitname2);
