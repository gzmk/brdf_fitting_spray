...
writetable(T,'/scratch/gk925/brdf_fitting_spray/gloss100_fit/sphere_3params_Conditions.txt','Delimiter','\t')
% writetable(T,'/Local/Users/gizem/Documents/Research/GlossBump/brdf_fitting_spray/gloss100_fit/sphere_3params_Conditions.txt','Delimiter','\t')

%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/brdf_fitting_spray/gloss100_fit');
% setpref('RenderToolbox3', 'workingFolder', '/Local/Users/gizem/Documents/Research/GlossBump/brdf_fitting_spray/gloss100_fit');
...
% imPath = ['/Local/Users/gizem/Documents/Research/GlossBump/brdf_fitting_spray/gloss100_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
imPath = ['/scratch/gk925/brdf_fitting_spray/gloss100_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
